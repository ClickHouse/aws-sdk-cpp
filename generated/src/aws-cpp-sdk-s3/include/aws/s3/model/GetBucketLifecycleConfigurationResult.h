...
class GetBucketLifecycleConfigurationResult {
 public:
  ...
  template <typename RulesT = Aws::Vector<LifecycleRule>>
  GetBucketLifecycleConfigurationResult& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = LifecycleRule>
  GetBucketLifecycleConfigurationResult& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
  ...
  inline GetBucketLifecycleConfigurationResult& WithTransitionDefaultMinimumObjectSize(TransitionDefaultMinimumObjectSize value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetBucketLifecycleConfigurationResult& WithRequestId(RequestIdT&& value) {
