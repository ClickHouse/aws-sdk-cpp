...
class UpdateObjectEncryptionResult {
 public:
  AWS_S3_API UpdateObjectEncryptionResult() = default;
  AWS_S3_API UpdateObjectEncryptionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_S3_API UpdateObjectEncryptionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
