...
class GetColumnStatisticsTaskSettingsResult {
 public:
  ...
  void SetColumnStatisticsTaskSettings(ColumnStatisticsTaskSettingsT&& value) {
    m_columnStatisticsTaskSettingsHasBeenSet = true;
    m_columnStatisticsTaskSettings = std::forward<ColumnStatisticsTaskSettingsT>(value);
  }
  template <typename ColumnStatisticsTaskSettingsT = ColumnStatisticsTaskSettings>
  GetColumnStatisticsTaskSettingsResult& WithColumnStatisticsTaskSettings(ColumnStatisticsTaskSettingsT&& value) {
    SetColumnStatisticsTaskSettings(std::forward<ColumnStatisticsTaskSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetColumnStatisticsTaskSettingsResult& WithRequestId(RequestIdT&& value) {
