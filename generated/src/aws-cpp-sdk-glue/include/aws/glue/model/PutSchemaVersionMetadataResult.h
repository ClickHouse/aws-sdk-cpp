...
class PutSchemaVersionMetadataResult {
 public:
  AWS_GLUE_API PutSchemaVersionMetadataResult() = default;
  ...
  template <typename SchemaArnT = Aws::String>
  PutSchemaVersionMetadataResult& WithSchemaArn(SchemaArnT&& value) {
  ...
  template <typename SchemaNameT = Aws::String>
  PutSchemaVersionMetadataResult& WithSchemaName(SchemaNameT&& value) {
  ...
  template <typename RegistryNameT = Aws::String>
  PutSchemaVersionMetadataResult& WithRegistryName(RegistryNameT&& value) {
  ...
  inline void SetLatestVersion(bool value) {
    m_latestVersionHasBeenSet = true;
    m_latestVersion = value;
  }
  inline PutSchemaVersionMetadataResult& WithLatestVersion(bool value) {
  ...
  inline PutSchemaVersionMetadataResult& WithVersionNumber(long long value) {
  ...
  template <typename SchemaVersionIdT = Aws::String>
  PutSchemaVersionMetadataResult& WithSchemaVersionId(SchemaVersionIdT&& value) {
  ...
  template <typename MetadataKeyT = Aws::String>
  PutSchemaVersionMetadataResult& WithMetadataKey(MetadataKeyT&& value) {
  ...
  template <typename MetadataValueT = Aws::String>
  PutSchemaVersionMetadataResult& WithMetadataValue(MetadataValueT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutSchemaVersionMetadataResult& WithRequestId(RequestIdT&& value) {
