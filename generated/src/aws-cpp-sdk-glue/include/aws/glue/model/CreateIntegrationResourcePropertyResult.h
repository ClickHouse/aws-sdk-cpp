...
class CreateIntegrationResourcePropertyResult {
 public:
  AWS_GLUE_API CreateIntegrationResourcePropertyResult() = default;
  ...
  template <typename ResourceArnT = Aws::String>
  CreateIntegrationResourcePropertyResult& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename SourceProcessingPropertiesT = SourceProcessingProperties>
  CreateIntegrationResourcePropertyResult& WithSourceProcessingProperties(SourceProcessingPropertiesT&& value) {
  ...
  template <typename TargetProcessingPropertiesT = TargetProcessingProperties>
  CreateIntegrationResourcePropertyResult& WithTargetProcessingProperties(TargetProcessingPropertiesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateIntegrationResourcePropertyResult& WithRequestId(RequestIdT&& value) {
