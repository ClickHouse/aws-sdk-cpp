...
class GetDevEndpointsResult {
 public:
  ...
  template <typename DevEndpointsT = Aws::Vector<DevEndpoint>>
  GetDevEndpointsResult& WithDevEndpoints(DevEndpointsT&& value) {
    SetDevEndpoints(std::forward<DevEndpointsT>(value));
    return *this;
  }
  template <typename DevEndpointsT = DevEndpoint>
  GetDevEndpointsResult& AddDevEndpoints(DevEndpointsT&& value) {
    m_devEndpointsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetDevEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDevEndpointsResult& WithRequestId(RequestIdT&& value) {
