...
class CreateMLTransformResult {
 public:
  AWS_GLUE_API CreateMLTransformResult() = default;
  ...
  template <typename TransformIdT = Aws::String>
  CreateMLTransformResult& WithTransformId(TransformIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateMLTransformResult& WithRequestId(RequestIdT&& value) {
