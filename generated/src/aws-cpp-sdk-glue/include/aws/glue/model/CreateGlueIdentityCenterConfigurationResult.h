...
class CreateGlueIdentityCenterConfigurationResult {
 public:
  ...
  AWS_GLUE_API CreateGlueIdentityCenterConfigurationResult& operator=(
  ...
  template <typename ApplicationArnT = Aws::String>
  CreateGlueIdentityCenterConfigurationResult& WithApplicationArn(ApplicationArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateGlueIdentityCenterConfigurationResult& WithRequestId(RequestIdT&& value) {
