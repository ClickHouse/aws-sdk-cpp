...
class ListDataQualityRulesetEvaluationRunsResult {
 public:
  ...
  AWS_GLUE_API ListDataQualityRulesetEvaluationRunsResult& operator=(
  ...
  template <typename RunsT = Aws::Vector<DataQualityRulesetEvaluationRunDescription>>
  ListDataQualityRulesetEvaluationRunsResult& WithRuns(RunsT&& value) {
    SetRuns(std::forward<RunsT>(value));
    return *this;
  }
  template <typename RunsT = DataQualityRulesetEvaluationRunDescription>
  ListDataQualityRulesetEvaluationRunsResult& AddRuns(RunsT&& value) {
    m_runsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityRulesetEvaluationRunsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataQualityRulesetEvaluationRunsResult& WithRequestId(RequestIdT&& value) {
