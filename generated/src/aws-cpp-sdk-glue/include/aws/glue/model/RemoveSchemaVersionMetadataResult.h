...
class RemoveSchemaVersionMetadataResult {
 public:
  ...
  template <typename SchemaArnT = Aws::String>
  RemoveSchemaVersionMetadataResult& WithSchemaArn(SchemaArnT&& value) {
  ...
  template <typename SchemaNameT = Aws::String>
  RemoveSchemaVersionMetadataResult& WithSchemaName(SchemaNameT&& value) {
  ...
  template <typename RegistryNameT = Aws::String>
  RemoveSchemaVersionMetadataResult& WithRegistryName(RegistryNameT&& value) {
  ...
  inline RemoveSchemaVersionMetadataResult& WithLatestVersion(bool value) {
  ...
  inline RemoveSchemaVersionMetadataResult& WithVersionNumber(long long value) {
  ...
  template <typename SchemaVersionIdT = Aws::String>
  RemoveSchemaVersionMetadataResult& WithSchemaVersionId(SchemaVersionIdT&& value) {
  ...
  template <typename MetadataKeyT = Aws::String>
  RemoveSchemaVersionMetadataResult& WithMetadataKey(MetadataKeyT&& value) {
  ...
  template <typename MetadataValueT = Aws::String>
  RemoveSchemaVersionMetadataResult& WithMetadataValue(MetadataValueT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RemoveSchemaVersionMetadataResult& WithRequestId(RequestIdT&& value) {
