...
class ListCrawlersResult {
 public:
  ...
  void SetCrawlerNames(CrawlerNamesT&& value) {
    ...
    m_crawlerNames = std::forward<CrawlerNamesT>(value);
  }
  template <typename CrawlerNamesT = Aws::Vector<Aws::String>>
  ListCrawlersResult& WithCrawlerNames(CrawlerNamesT&& value) {
    SetCrawlerNames(std::forward<CrawlerNamesT>(value));
    return *this;
  }
  template <typename CrawlerNamesT = Aws::String>
  ListCrawlersResult& AddCrawlerNames(CrawlerNamesT&& value) {
    m_crawlerNamesHasBeenSet = true;
    m_crawlerNames.emplace_back(std::forward<CrawlerNamesT>(value));
    return *this;
  }
  ///@}
