...
class GetEntityRecordsResult {
 public:
  ...
  template <typename RecordsT = Aws::Vector<Aws::Utils::Document>>
  GetEntityRecordsResult& WithRecords(RecordsT&& value) {
    SetRecords(std::forward<RecordsT>(value));
    return *this;
  }
  template <typename RecordsT = Aws::Utils::Document>
  GetEntityRecordsResult& AddRecords(RecordsT&& value) {
    m_recordsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetEntityRecordsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetEntityRecordsResult& WithRequestId(RequestIdT&& value) {
