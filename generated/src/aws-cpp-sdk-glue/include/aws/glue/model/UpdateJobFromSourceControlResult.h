...
class UpdateJobFromSourceControlResult {
 public:
  AWS_GLUE_API UpdateJobFromSourceControlResult() = default;
  ...
  template <typename JobNameT = Aws::String>
  UpdateJobFromSourceControlResult& WithJobName(JobNameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateJobFromSourceControlResult& WithRequestId(RequestIdT&& value) {
