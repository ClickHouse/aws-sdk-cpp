...
class ListCustomEntityTypesResult {
 public:
  ...
  template <typename CustomEntityTypesT = Aws::Vector<CustomEntityType>>
  ListCustomEntityTypesResult& WithCustomEntityTypes(CustomEntityTypesT&& value) {
    SetCustomEntityTypes(std::forward<CustomEntityTypesT>(value));
    return *this;
  }
  template <typename CustomEntityTypesT = CustomEntityType>
  ListCustomEntityTypesResult& AddCustomEntityTypes(CustomEntityTypesT&& value) {
    m_customEntityTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomEntityTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomEntityTypesResult& WithRequestId(RequestIdT&& value) {
