...
class GetDataQualityModelResultResult {
 public:
  ...
  template <typename CompletedOnT = Aws::Utils::DateTime>
  GetDataQualityModelResultResult& WithCompletedOn(CompletedOnT&& value) {
  ...
  template <typename ModelT = Aws::Vector<StatisticModelResult>>
  GetDataQualityModelResultResult& WithModel(ModelT&& value) {
    SetModel(std::forward<ModelT>(value));
    return *this;
  }
  template <typename ModelT = StatisticModelResult>
  GetDataQualityModelResultResult& AddModel(ModelT&& value) {
    m_modelHasBeenSet = true;
    m_model.emplace_back(std::forward<ModelT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetDataQualityModelResultResult& WithRequestId(RequestIdT&& value) {
