...
class ListDataQualityStatisticAnnotationsResult {
 public:
  ...
  template <typename AnnotationsT = Aws::Vector<StatisticAnnotation>>
  ListDataQualityStatisticAnnotationsResult& WithAnnotations(AnnotationsT&& value) {
    SetAnnotations(std::forward<AnnotationsT>(value));
    return *this;
  }
  template <typename AnnotationsT = StatisticAnnotation>
  ListDataQualityStatisticAnnotationsResult& AddAnnotations(AnnotationsT&& value) {
    m_annotationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityStatisticAnnotationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataQualityStatisticAnnotationsResult& WithRequestId(RequestIdT&& value) {
