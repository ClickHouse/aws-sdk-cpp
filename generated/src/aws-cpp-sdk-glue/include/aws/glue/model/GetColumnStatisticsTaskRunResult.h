...
class GetColumnStatisticsTaskRunResult {
 public:
  ...
  void SetColumnStatisticsTaskRun(ColumnStatisticsTaskRunT&& value) {
    m_columnStatisticsTaskRunHasBeenSet = true;
    m_columnStatisticsTaskRun = std::forward<ColumnStatisticsTaskRunT>(value);
  }
  template <typename ColumnStatisticsTaskRunT = ColumnStatisticsTaskRun>
  GetColumnStatisticsTaskRunResult& WithColumnStatisticsTaskRun(ColumnStatisticsTaskRunT&& value) {
    SetColumnStatisticsTaskRun(std::forward<ColumnStatisticsTaskRunT>(value));
    return *this;
  }
  ///@}
