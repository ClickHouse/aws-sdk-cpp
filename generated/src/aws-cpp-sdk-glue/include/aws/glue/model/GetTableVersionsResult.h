...
class GetTableVersionsResult {
 public:
  ...
  void SetTableVersions(TableVersionsT&& value) {
    m_tableVersionsHasBeenSet = true;
    m_tableVersions = std::forward<TableVersionsT>(value);
  }
  template <typename TableVersionsT = Aws::Vector<TableVersion>>
  GetTableVersionsResult& WithTableVersions(TableVersionsT&& value) {
    SetTableVersions(std::forward<TableVersionsT>(value));
    return *this;
  }
  template <typename TableVersionsT = TableVersion>
  GetTableVersionsResult& AddTableVersions(TableVersionsT&& value) {
    m_tableVersionsHasBeenSet = true;
    m_tableVersions.emplace_back(std::forward<TableVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetTableVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetTableVersionsResult& WithRequestId(RequestIdT&& value) {
