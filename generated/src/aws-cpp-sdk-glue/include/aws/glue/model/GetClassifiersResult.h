...
class GetClassifiersResult {
 public:
  ...
  template <typename ClassifiersT = Aws::Vector<Classifier>>
  GetClassifiersResult& WithClassifiers(ClassifiersT&& value) {
    SetClassifiers(std::forward<ClassifiersT>(value));
    return *this;
  }
  template <typename ClassifiersT = Classifier>
  GetClassifiersResult& AddClassifiers(ClassifiersT&& value) {
    m_classifiersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetClassifiersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetClassifiersResult& WithRequestId(RequestIdT&& value) {
