...
class GetCrawlerMetricsResult {
 public:
  ...
  void SetCrawlerMetricsList(CrawlerMetricsListT&& value) {
    m_crawlerMetricsListHasBeenSet = true;
    m_crawlerMetricsList = std::forward<CrawlerMetricsListT>(value);
  }
  template <typename CrawlerMetricsListT = Aws::Vector<CrawlerMetrics>>
  GetCrawlerMetricsResult& WithCrawlerMetricsList(CrawlerMetricsListT&& value) {
    SetCrawlerMetricsList(std::forward<CrawlerMetricsListT>(value));
    return *this;
  }
  template <typename CrawlerMetricsListT = CrawlerMetrics>
  GetCrawlerMetricsResult& AddCrawlerMetricsList(CrawlerMetricsListT&& value) {
    m_crawlerMetricsListHasBeenSet = true;
    m_crawlerMetricsList.emplace_back(std::forward<CrawlerMetricsListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetCrawlerMetricsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCrawlerMetricsResult& WithRequestId(RequestIdT&& value) {
