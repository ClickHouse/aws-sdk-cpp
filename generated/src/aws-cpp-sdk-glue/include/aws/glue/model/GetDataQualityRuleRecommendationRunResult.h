...
class GetDataQualityRuleRecommendationRunResult {
 public:
  ...
  template <typename RunIdT = Aws::String>
  GetDataQualityRuleRecommendationRunResult& WithRunId(RunIdT&& value) {
  ...
  template <typename DataSourceT = DataSource>
  GetDataQualityRuleRecommendationRunResult& WithDataSource(DataSourceT&& value) {
  ...
  template <typename RoleT = Aws::String>
  GetDataQualityRuleRecommendationRunResult& WithRole(RoleT&& value) {
  ...
  inline GetDataQualityRuleRecommendationRunResult& WithNumberOfWorkers(int value) {
  ...
  inline GetDataQualityRuleRecommendationRunResult& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline GetDataQualityRuleRecommendationRunResult& WithStatus(TaskStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorStringT = Aws::String>
  GetDataQualityRuleRecommendationRunResult& WithErrorString(ErrorStringT&& value) {
  ...
  template <typename StartedOnT = Aws::Utils::DateTime>
  GetDataQualityRuleRecommendationRunResult& WithStartedOn(StartedOnT&& value) {
  ...
  template <typename LastModifiedOnT = Aws::Utils::DateTime>
  GetDataQualityRuleRecommendationRunResult& WithLastModifiedOn(LastModifiedOnT&& value) {
  ...
  template <typename CompletedOnT = Aws::Utils::DateTime>
  GetDataQualityRuleRecommendationRunResult& WithCompletedOn(CompletedOnT&& value) {
  ...
  inline GetDataQualityRuleRecommendationRunResult& WithExecutionTime(int value) {
  ...
  void SetRecommendedRuleset(RecommendedRulesetT&& value) {
    m_recommendedRulesetHasBeenSet = true;
    m_recommendedRuleset = std::forward<RecommendedRulesetT>(value);
  }
  template <typename RecommendedRulesetT = Aws::String>
  GetDataQualityRuleRecommendationRunResult& WithRecommendedRuleset(RecommendedRulesetT&& value) {
    SetRecommendedRuleset(std::forward<RecommendedRulesetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedRulesetNameT = Aws::String>
  GetDataQualityRuleRecommendationRunResult& WithCreatedRulesetName(CreatedRulesetNameT&& value) {
  ...
  template <typename DataQualitySecurityConfigurationT = Aws::String>
  GetDataQualityRuleRecommendationRunResult& WithDataQualitySecurityConfiguration(DataQualitySecurityConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDataQualityRuleRecommendationRunResult& WithRequestId(RequestIdT&& value) {
