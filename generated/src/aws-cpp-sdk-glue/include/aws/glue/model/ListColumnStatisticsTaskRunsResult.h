...
class ListColumnStatisticsTaskRunsResult {
 public:
  ...
  void SetColumnStatisticsTaskRunIds(ColumnStatisticsTaskRunIdsT&& value) {
    m_columnStatisticsTaskRunIdsHasBeenSet = true;
    m_columnStatisticsTaskRunIds = std::forward<ColumnStatisticsTaskRunIdsT>(value);
  }
  template <typename ColumnStatisticsTaskRunIdsT = Aws::Vector<Aws::String>>
  ListColumnStatisticsTaskRunsResult& WithColumnStatisticsTaskRunIds(ColumnStatisticsTaskRunIdsT&& value) {
    SetColumnStatisticsTaskRunIds(std::forward<ColumnStatisticsTaskRunIdsT>(value));
    return *this;
  }
  template <typename ColumnStatisticsTaskRunIdsT = Aws::String>
  ListColumnStatisticsTaskRunsResult& AddColumnStatisticsTaskRunIds(ColumnStatisticsTaskRunIdsT&& value) {
    m_columnStatisticsTaskRunIdsHasBeenSet = true;
    m_columnStatisticsTaskRunIds.emplace_back(std::forward<ColumnStatisticsTaskRunIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListColumnStatisticsTaskRunsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListColumnStatisticsTaskRunsResult& WithRequestId(RequestIdT&& value) {
