...
class GetCatalogsResult {
 public:
  ...
  void SetCatalogList(CatalogListT&& value) {
    m_catalogListHasBeenSet = true;
    m_catalogList = std::forward<CatalogListT>(value);
  }
  template <typename CatalogListT = Aws::Vector<Catalog>>
  GetCatalogsResult& WithCatalogList(CatalogListT&& value) {
    SetCatalogList(std::forward<CatalogListT>(value));
    return *this;
  }
  template <typename CatalogListT = Catalog>
  GetCatalogsResult& AddCatalogList(CatalogListT&& value) {
    m_catalogListHasBeenSet = true;
    m_catalogList.emplace_back(std::forward<CatalogListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetCatalogsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCatalogsResult& WithRequestId(RequestIdT&& value) {
